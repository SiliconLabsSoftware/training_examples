...
//! **Find Me (Step 2b: LEDs) - State Transition Diagram**
//! ```mermaid
//! stateDiagram-v2
...
const output_config_t output_config[] = {
	{true, true, true, 50, 1450},	// APP_STATE_IDLE
	{false, false, true, 50, 1450},	// APP_STATE_ADVERTISING
	{false, true, false, 50, 1450}  // APP_STATE_CONNECTED
};
// LED GPIOs
